...
module.exports = {
    config: {
        name: "cat", // name
        aliases: ["cats","neko","kitty","kitties","pussies","pussy","catto"], // alt name
        category: "image",
        description: "Fetches random cat images", // random what?
        usage: `(command)`,
    ...
    run: async (client, message, args) => {
        ...
        type: 'custom', subreddit: ['cats','kitties','sleepingcats','catswithjobs','kitten','kittens','kittengifs']}).then(result => {
