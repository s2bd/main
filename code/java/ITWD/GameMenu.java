...
public class GameMenu extends JPanel implements ActionListener {
    ...
    private void loadResources() {
        // Load custom fonts
        try {
            customTitleFont = Font.createFont(Font.TRUETYPE_FONT, new File("Assets/eternal.ttf")).deriveFont(50f);
            customMenuFont = Font.createFont(Font.TRUETYPE_FONT, new File("Assets/LeningradDisco.ttf")).deriveFont(24f);
            customTextFont = Font.createFont(Font.TRUETYPE_FONT, new File("Assets/Gugi.ttf")).deriveFont(20f);
            cursorImage = Toolkit.getDefaultToolkit().getImage("Assets/cursor.png");
            customCursor = Toolkit.getDefaultToolkit().createCustomCursor(cursorImage, new Point(0, 0), "Custom Cursor");
            adam = Toolkit.getDefaultToolkit().getImage("Assets/adam.png");
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        hoverSound = loadSound("Assets/hover.wav");
