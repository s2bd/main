...
public class GradingTestWatcher implements TestWatcher, AfterAllCallback {
    ...
    public void afterAll(ExtensionContext context){
        ...
        if(c.isPresent()){
            GradeValue anno = c.getClass().getAnnotation(GradeValue.class); // not working
            classValue = anno != null ? anno.value() : -1;
        }

        System.out.println(String.format("Total: %d/%d", totalGrade,totVal));
        //System.out.println(sb + "Bye");
    }
